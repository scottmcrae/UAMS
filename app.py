...
<div style="display:flex;gap:10px;margin-top:8px;">
  <a href="#" onclick="navigator.clipboard.writeText('{_kw_js}').then(function(){{ window.open('https://www.goodrx.com','_blank'); }});return false;"
     style="background:#e8913a;color:white;padding:7px 16px;border-radius:8px;font-size:0.85rem;font-weight:600;text-decoration:none;cursor:pointer;">
     💊 GoodRx
  </a>
  <a href="#" onclick="navigator.clipboard.writeText('{_kw_js}').then(function(){{ window.open('https://www.openevidence.com','_blank'); }});return false;"
     style="background:#0d7a6e;color:white;padding:7px 16px;border-radius:8px;font-size:0.85rem;font-weight:600;text-decoration:none;cursor:pointer;">
     🔬 OpenEvidence
  </a>
</div>
{"<div style='font-size:0.75rem;color:#6b7e8f;margin-top:4px;margin-left:2px;'>📋 <em>\"" + _kw + "\" copied to clipboard — paste into search</em></div>" if _kw else ""}
""", unsafe_allow_html=True)
