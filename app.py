            ...
            if _multi_entries:
                ...
                if best_entry:
                    ...
                    pa_criteria_link = (
                        ...
                        f'<div style="position:absolute;left:0;top:1.6rem;z-index:999;min-width:500px;max-width:90vw;margin-top:4px;padding:14px 16px;background:#fffbf0;border-left:3px solid #e8913a;border-radius:0 6px 6px 0;max-height:380px;overflow-y:auto;">'
                        f'{_inner}'
                        f'</div></details>'
                    )
                else:
