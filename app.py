...
""", unsafe_allow_html=True)
    ...
    <div class="{card_class}">
      ...
      <div style="margin-top:6px;display:flex;gap:8px;">
        <a href="{goodrx_url}" target="_blank" style="background:#e05c00;color:white;padding:4px 12px;border-radius:6px;font-size:0.78rem;font-weight:600;text-decoration:none;">💊 GoodRx</a>
