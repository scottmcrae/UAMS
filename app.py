    ...
    with _results_placeholder.container():
        if not _fda_medguides:
            ...
            for _d in _fda_matches:
                ...
                _text_preview = ""
                if _text:
                    _iu_m = _re.search(r'-+\s*INDICATIONS AND USAGE\s*-+', _text)
                    ...
                    _text_preview = (
                        ...
                        f'Indications and Usage</div>'
                        f'<div style="padding:10px 14px;background:#f8fafc;border-radius:6px;'
                        f'font-size:0.78rem;line-height:1.6;color:#1e3448;white-space:pre-wrap;'
                        f'max-height:400px;overflow-y:auto;">'
                        f'{_preview_raw}</div></div>'
                    )
