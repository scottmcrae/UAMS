            ...
            if pa_criteria_url and has_pa:
                if pa_criteria_text:
                    ...
                    pa_criteria_link = (
                        ...
                        f'<div style="margin-top:8px;padding:12px 14px;background:#fffbf0;border-left:3px solid #e8913a;border-radius:0 6px 6px 0;font-size:0.78rem;line-height:1.7;color:#2a3a4a;white-space:pre-wrap;font-family:monospace;max-height:300px;overflow-y:auto;">'
                        f'{snippet_html}'
