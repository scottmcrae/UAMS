...
with st.form("search_form"):
    col_search, col_btn, col_grx, col_oe = st.columns([5, 1, 1, 1])
    with col_search:
    ...
    with col_grx:
        st.markdown('<a href="https://www.goodrx.com/" target="_blank" style="display:block;background:#C89647;color:white;padding:7px 10px;border-radius:8px;font-size:0.85rem;font-weight:600;text-decoration:none;text-align:center;">💊 GoodRx</a>', unsafe_allow_html=True)
    with col_oe:
        st.markdown('<a href="https://www.openevidence.com" target="_blank" style="display:block;background:#734702;color:white;padding:7px 10px;border-radius:8px;font-size:0.85rem;font-weight:600;text-decoration:none;text-align:center;">🔬 OpenEvidence</a>', unsafe_allow_html=True)
