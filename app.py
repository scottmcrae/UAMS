    ...
    with _results_placeholder.container():
        if not _fda_medguides:
            ...
            for _d in _fda_matches:
                ...
                _text_preview = ""
                if _text:
                    # Find INDICATIONS AND USAGE that isn't a TOC entry
                    # TOC lines have dots or (1) after them, or are on a line with page numbers
                    _ind_m = None
                    for _m in _re.finditer(r'INDICATIONS AND USAGE', _text, _re.IGNORECASE):
                        ...
                        # Skip if line contains dots or (1) — TOC entry
