...
<style>
    ...
    /* ── Search input border ── */
    /* ── Align GoodRx/OE buttons under search bar ── */
    div.goodrx-btn-row {
...
st.markdown(f"""
<style>
  div[data-testid="stHorizontalBlock"]:has(div.goodrx-btn-row) {{
    margin-top: -8px;
  }}
</style>
<div class="goodrx-btn-row" style="display:flex;gap:10px;padding-left:0px;margin-top:4px;margin-bottom:4px;">
