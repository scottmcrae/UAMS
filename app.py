...
if go and keyword.strip():
    ...
    for r in (found_results + [] + []):
        ...
        if is_tricare:
            ...
            pa_criteria_link = (
                f' <a href="{pa_criteria_url}" target="_blank" style="font-size:0.75rem;color:#856404;font-weight:500;text-decoration:none;border-bottom:1px dashed #856404;">PA Criteria ↗</a>'
                if pa_criteria_url else ""
            )
            pa_html = ('<span style="font-size:0.75rem;background:#FFF3CD;color:#856404;padding:2px 8px;border-radius:20px;margin-left:6px;font-weight:500;">PA</span>' + pa_criteria_link) if has_pa else (pa_criteria_link if pa_criteria_url else "")
