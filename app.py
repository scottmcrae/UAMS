            ...
            if pa_criteria_url and has_pa:
                if pa_criteria_text:
                    ...
                    pa_criteria_link = (
                        ...
                        f'<summary style="display:inline;font-size:0.75rem;color:#856404;font-weight:700;cursor:pointer;border-bottom:1px dashed #856404;">PA Criteria ▾</summary>'
                    ...
                    pa_criteria_link = (
                        f' <a href="{pa_criteria_url}" target="_blank" style="font-size:0.75rem;color:#856404;font-weight:700;text-decoration:none;border-bottom:1px dashed #856404;margin-left:15px;">PA Criteria ↗</a>'
                    )
            else:
                pa_criteria_link = ""
