...
<style>
    ...
    * { font-family: 'DM Sans', sans-serif; }
    ...
    .header-bar {
        background: #BF6D65;
        background-image: linear-gradient(135deg, #a85c55 0%, #BF6D65 50%, #cc7b73 100%);
        color: white;
        padding: 28px 32px;
        border-radius: 14px;
        margin-bottom: 28px;
...
<div style="display:flex;gap:10px;margin-top:8px;">
  <a href="https://www.goodrx.com/" target="_blank" style="background:#F29B30;color:white;padding:7px 16px;border-radius:8px;font-size:0.85rem;font-weight:600;text-decoration:none;">💊 GoodRx</a>
  <a href="https://www.openevidence.com" target="_blank" style="background:#F27830;color:white;padding:7px 16px;border-radius:8px;font-size:0.85rem;font-weight:600;text-decoration:none;">🔬 OpenEvidence</a>
</div>
