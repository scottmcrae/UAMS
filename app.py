...
<style>
    ...
    * { font-family: 'DM Sans', sans-serif; }
    ...
    .header-bar {
        ...
        background-image: linear-gradient(135deg, #2a4a7a 0%, #416CA6 50%, #548DBF 100%);
        color: white;
        padding: 28px 32px;
        border-radius: 14px;
        margin-bottom: 28px;
...
<div style="display:flex;gap:10px;margin-top:8px;">
  <a href="https://www.goodrx.com/" target="_blank" style="background:#F27830;color:white;padding:7px 16px;border-radius:8px;font-size:0.85rem;font-weight:600;text-decoration:none;">💊 GoodRx</a>
  <a href="https://www.openevidence.com" target="_blank" style="background:#416CA6;color:white;padding:7px 16px;border-radius:8px;font-size:0.85rem;font-weight:600;text-decoration:none;">🔬 OpenEvidence</a>
</div>
{"<div style='font-size:0.75rem;color:#6b7e8f;margin-top:6px;margin-left:2px;'>📋 Search term: <strong>" + _kw + "</strong> — copy &amp; paste into either site</div>" if _kw else ""}
""", unsafe_allow_html=True)
