...
# Buttons below, aligned under the search bar
    ...
    with _results_placeholder.container():
        if not _ai_criteria:
            ...
            for _d in _ai_matches:
                ...
                _s2      = _d.get("Section2_AppealReadyNarrative", "")

                # Build structured content
                _content = ""

                # Indications
                _inds = _s1.get("Indications", [])
                if _inds:
                ...
                # Step Therapy
                _st = _s1.get("StepTherapyProtocols", {})
                if _st:
                ...
                # Reauthorization
                _reauth = _s1.get("ReauthorizationRequirements", [])
                if _reauth:
                ...
                _cov = _s1.get("CoverageConsiderations", {})
                if _cov:
                ...
                _refs = _s1.get("GuidelineReferences", {})
                if _refs:
