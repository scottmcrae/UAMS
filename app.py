...
""", unsafe_allow_html=True)
    ...
    for r in (found_results + [] + []):
        ...
        tier = extract_tier(r.get("text",""), keyword) if r["found"] else None
    ...
    <div class="{card_class}">
      ...
      <div style="margin-top:6px;display:flex;gap:8px;">
        <a href="https://www.goodrx.com/{keyword.strip().lower().replace(' ','-')}" target="_blank" style="background:#e05c00;color:white;padding:4px 12px;border-radius:6px;font-size:0.78rem;font-weight:600;text-decoration:none;">💊 GoodRx</a>
        <a href="https://www.openevidence.com" target="_blank" style="background:#2c5f8a;color:white;padding:4px 12px;border-radius:6px;font-size:0.78rem;font-weight:600;text-decoration:none;">🔬 OpenEvidence</a>
      </div>
